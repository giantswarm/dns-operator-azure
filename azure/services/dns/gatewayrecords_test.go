...
import (
	...
	dnscope "github.com/giantswarm/dns-operator-azure/v3/azure/scope"
...
func newGatewayTestService(t *testing.T, ctx context.Context, wcServices []*corev1.Service) *Service {
	...
	dnsScope, err := dnscope.NewDNSScope(ctx, dnscope.DNSScopeParams{
		BaseZoneCredentials: dnscope.BaseZoneCredentials{
